  ...
  fields: {
    ...
    search: {
      ...
      args: {
        ...
        until: {
          type: GraphQLString,
          description: "Returns tweets before the given date. Format: YYYY-MM-DD. The api has a 7 day limit."
        },
        since_id: {
          type: GraphQLString,
          description: "Returns tweets newer then given ID"
        },
        max_id: {
          type: GraphQLString,
          description: "Returns tweets older then given ID"
        }
      },
